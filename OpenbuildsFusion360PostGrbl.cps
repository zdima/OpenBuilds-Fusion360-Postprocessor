...
properties =
{
   spindleOnOffDelay: 1.8,        // time (in seconds) the spindle needs to get up to speed or stop, or laser pierce delay
...
function onClose() {
   ...
   if (!isLaser ) {
      ...
      if (properties.UseZ)
         writeBlock(gMotionModal.format(0), zOutput.format(Zmax));
